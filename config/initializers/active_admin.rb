...
ActiveAdmin.setup do |config|
  ...
  #
  config.site_title = "Arctic Admin Demo"
  ...
  #
    ...
    #     menu.add :label => "Developer" do |dev|
    #       dev.add :label => "SimpleCov Report", :url => "open coverage/index.html", :html_options => { :target => :blank }
    #     end
    #   end
    # end
